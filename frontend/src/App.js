...
function App() {
  ...
  React.useEffect(() => {
    document.body.classList.toggle("app-light-bg", !darkMode);
  }, [darkMode]);
  ...
  return (
    <>
      ...
      >
        ...
        <Container style={{ paddingTop: "20px", paddingBottom: "32px" }}>
          <UploadCard
            uploading={uploading}
            darkMode={darkMode}
          ...
          {pdfs.length > 0 && (
            ...
            >
              {pdfs.map((pdf) => {
                const isActive = selectedPdf === pdf.id;
                return (
                  <button
                    key={pdf.id}
                    onClick={() => {
                    ...
                    style={{
                      ...
                      background: isActive
                        ...
                        : "#fff",
                      color: isActive ? "#fff" : darkMode ? "#E5E7EB" : "#333",
                      cursor: "pointer",
                      fontWeight: 600,
                      fontSize: "13px",
                      whiteSpace: "nowrap",
                      flexShrink: 0,
                      maxWidth: "220px",
                      boxShadow: isActive ? "0 8px 18px rgba(124,77,255,0.28)" : "none",
                    }}
                  >
                    <PictureAsPdfIcon
                      sx={{ fontSize: 15, color: isActive ? "#fff" : "#8B5CF6", flexShrink: 0 }}
                    />
                    <span
                      style={{
                        overflow: "hidden",
